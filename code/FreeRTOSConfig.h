...
This demo is expected to create three tasks (two tasks + idle task)
This constant is used to dimension an array which is used to trace
which task is running when for viewing on the logic analyzer window 
in the Keil simulator IDE. */

#define configEXPECTED_NO_RUNNING_TASKS		( 6 )
